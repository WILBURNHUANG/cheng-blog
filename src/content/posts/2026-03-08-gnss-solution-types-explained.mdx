...
| **SPP** | 5–10 m | Instant |
| **SBAS** | 1–3 m | Instant |
| **DGNSS** | 0.5–2 m | Instant |
| **PPP** | 10–30 cm | 15–30 min |
| **PPP-AR** | < 5 cm | 3–15 min |
| **RTK** | 1–2 cm | Seconds |
| **NRTK** | 2–3 cm | Seconds |
| **PPP-RTK** | 2–3 cm | < 1 min |
| **PPK** | 1–2 cm | Post-process |

### Coverage & Requirements

| Solution | Coverage | What You Need |
|----------|----------|---------------|
| **SPP** | Global | Receiver only |
| **SBAS** | Regional | SBAS receiver |
| **DGNSS** | ~50 km | Base + data link |
| **PPP** | Global | Correction service |
| **PPP-AR** | Global | AR service |
| **RTK** | ~20 km | Base + data link |
| **NRTK** | Network area | CORS subscription |
| **PPP-RTK** | Regional | SSR service |
| **PPK** | ~50 km | Post-processing SW |
