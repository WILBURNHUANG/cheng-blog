...
**IMPORTANT**: Save the generated MDX file directly to the blog's content folder:
`/mnt/c/Users/Cheng/cheng-blog/src/content/posts/YYYY-MM-DD-daily-tech-gnss-news.mdx`
...
5. **Save as MDX file** to `src/content/posts/` with today's date in filename: `YYYY-MM-DD-daily-tech-gnss-news.mdx`
